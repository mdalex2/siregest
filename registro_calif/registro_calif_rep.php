...
<link rel="alternate" media="print" href="registro_calif_rep.php"> 
<style type="text/css">
...
include_once("../funciones/funcionesPHP.php");
		if (!empty($_REQUEST["cmb_secc"])){
			$id_seccion=$_REQUEST["cmb_secc"];
			$cod_asig=$_REQUEST["cmb_asig"];
			$cod_grado=$_REQUEST["cmb_gra"];
			$cod_anno_esc=$_REQUEST["cmb_anno_esc"];
			$cod_plantel=$_REQUEST["cmb_plan"];
...
<table class="margenes" width="100%" border="1" cellpadding="0" cellspacing="1" bordercolor="#000000" style="border-collapse: collapse;font-weight: normal; text-transform:uppercase;height: 30px;">
  ...
  <tr>
    <td><div class="ctrlHolder">
      ...
      <label><b><?php echo $_REQUEST["cmb_anno_esc"];?></b></label>
      <br />
    </div></td>
    <td><div class="ctrlHolder">
...
<div class="ctrlHolder" style="margin:0px;">
  ...
  <tr>
    ...
    <label><b><?php if (!empty($_REQUEST["txt_nom_asig"])) echo $_REQUEST["txt_nom_asig"]; else echo "NO DEFINIDA";;?></b></label>
    <br></div></td>
    <td colspan="2"><div class="ctrlHolder" style="margin:0px;">
    <?php
...
<button type="button" name="cerrar" id="cerrar" value="Imprimir" onclick="window.close();"><img src="../images/sistema/close_windows.png" width="32" height="32" align="absmiddle" />&nbsp;Cerrar</button>
  ...
  <tr>
    <td align="left" ><p class="formHint" style="margin:0px;">NOMBRE / N&deg;C&Eacute;DULA:</p></td>
    <td>&nbsp;</td>
    <td align="center" >&nbsp;</td>
  </tr>
