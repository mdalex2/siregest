...
{
var agree=confirm("¿Está seguro de eliminar éste apunte de agenda?");
if (agree)
return true ;
else
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Agenda de tareas</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      <img src="<?php 
											...
											switch ($accion){
												case "NUEVO" :
													...
													break;
												default:
													echo "../images/icons_menu/x32/00063.png";
													break;
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: AGENDA DE TAREAS 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("agenda_bus.php");
								break;
							 case "NUEVO":
							 	include_once("agenda_crea.php");
								break;
							 case "MOSTRAR":
          ...
          <a id="nb" href="<?php echo "agenda.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Buscar tareas">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "agenda.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
									<img src='../images/icons_menu/x32/00063.png' width='24' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Nueva tarea&nbsp;               
                  </a><br>              
