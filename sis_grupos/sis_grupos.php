...
?><head>
<link href="../images/sistema/icono_sis.ico" type="image/x-icon" rel="shortcut icon" />
<script type="text/javascript">
function confirmSubmit()
{
var agree=confirm("¿Está seguro de eliminar éste tipo de documento?");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAREL GRUPO DE USUARIO? \n\n NOTA: SE RECOMIENDA NO ELIMINARLO AL MENOS QUE EL MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar el grupo de usuarios?\n\n Ésta acción no se podrá deshacer.");
	if (agree)
		return true ;}
else
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Grupos de usuarios</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: GRUPOS DE USUARIOS
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h2><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("sis_grupos_bus.php");
								break;
							 case "NUEVO":
							 	include_once("sis_grupos_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("sis_grupos_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("sis_grupos_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("sis_grupos_modif.php");
								modif_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR":
									include_once("sis_grupos_elim.php");
									eliminar_datos();
									break;																			
          ...
          <a id="nb" href="<?php echo "sis_grupos.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "sis_grupos.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
