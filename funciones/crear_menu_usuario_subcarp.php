...
verifica_caducidad_sesion();
			...
			echo '<div id="header" class="fondo_superior">';
				...
				echo '<div id="top">';
					...
					echo '<div class="logo"> ';
						echo '<a href="../acceso_sis/menu_principal.php" title="Ir a menu principal" class="tooltip"><img src="../wideadmin_files/logo.png" alt="Menú principal" width="600" height="89px"></a></div>';
					//<!-- End of Logo -->
					
					//<!-- Meta information -->
					echo '<div class="meta">
					<p><br><b>USUARIO:</b> '.strtoupper($_SESSION['nombre_usuario']).'</p>
						<ul>
                        	
							<li><a href="../funciones/salir_sistema.php" title="Salir del sistema" ><span
 class="ui-icon ui-icon-power"></span>Salir</a></li>
							
							<li><a href="informacion_cuenta.php" title="Información de la cuenta" ><span 
class="ui-icon ui-icon-person"></span>Mi cuenta</a></li>
<li><a href="mensajes.php" title="Revisar mensajes" ><span 
class="ui-icon ui-icon-mail-closed"></span>Mensajes (0)</a></li>
						</ul>
...
<ul class='nav sf-js-enabled sf-shadow'>
		...
		else
		{
         ...
         while ($row = mysql_fetch_array($res)){ 
                 //pregunto la cantidad de hijos que tiene el item que entra al primero le agrego <ul> y al ultimo hijo le agrego </ul>
				 				$id=$row["id_func"];
								$texto_icono=strtolower($row["texto_icono"]);
								$texto_icono=ucfirst($texto_icono);
    ...
    menu('-1', $menu);
		...
		// agrego la opcion de ayuda
   		$menu .= '<li><a href="../ayuda/ayuda.php"><img src="../images/icons_menu/x32/help.png" align="absmiddle" width="20" height="20"> Ayuda</a></li></ul>';
