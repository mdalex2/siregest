...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>"><title>Constancia de retiro</title>
<style type="text/css">
.margenes td{
padding-left: 3px;
padding-right: 3px;
...
<br /><br />
<center><span class="titulo" style="line-height: 300%;">CONSTANCIA DE RETIRO</span></center>
<p align="justify" style="font-size:16px;line-height: 200%;">
Quien suscribe, <?PHP echo $nombre_director." ".$apellido_director;?> titular de la c&eacute;dula de identidad N&deg; <?php echo formatear_id_personal($num_id_per,$tipo_doc_abr,$poner_num,$separador,$num_con_punto); ?>,<?php echo $genero_direct.$dir_encarg;?> de la <?php echo $nombre_plantel;?>, c&oacute;digo de Plantel <?php echo $cod_plantel;?>, que funciona en <?php echo $poblado?>, Municipio <?php echo $municipio;?> del Estado <?php echo $estado_terr;?>, por medio de la presente:
</p>
<center>
<span class="titulo">HACE CONSTAR</span>
</center>
<p align="justify" style="font-size:16px;line-height: 200%;">
Que <?php echo $genero_alum;?> estudiante <?php echo $nombre_alumno." ".$apellido_alumno;?>, titular de la c&eacute;dula de identidad N&deg; <?php echo formatear_id_personal($num_id_per,$tipo_doc_abr,$poner_num,$separador,$num_con_punto);?>, natural de <?php echo $lugar_nac_alum;?> <?php echo $estado_nac_alum;?>, <?php echo $nacidoa;?> el <?php echo $fecha_nac_larg;?> de <?php echo $edad_alum;?> a&ntilde;os de edad,<b> ha sido <?php echo $inscritoa."</b>";?> de &eacute;sta instituci&oacute;n de cursar el <?php echo $grado_anno." ".$seccion?>, para el per&iacute;odo escolar <?php echo $cod_anno_esc;?>; por motivo de <?php echo "cambio de residencia"?>.
</p>
<p align="justify" style="font-size:16px;line-height: 200%;">
...
<table width="100%" border="0" style="font-size:16px;">
  <tr>
    ...
    <th scope="col" style="border-top:1px solid black;"><?php 
		...
		echo strtoupper($genero_direct.$dir_encarg);
		?></th>
    <th scope="col" width="30%">&nbsp;</th>
  </tr>
</table>
