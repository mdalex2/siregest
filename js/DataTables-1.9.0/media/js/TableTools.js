...
TableTools.BUTTONS = {
	"csv": {
		...
		"sCharSet": "utf8",
		"bBomInc": false,
		"sFileName": "exportado.csv",
		"sFieldBoundary": '"',
		"sFieldSeperator": ",",
		"sNewLine": "auto",
		"sTitle": "",
		"sToolTip": "Exportar a CVS separado por coma",
	...
	"xls": {
		...
		"sNewLine": "auto",
		"sTitle": "",
		"sToolTip": "Exportar a CVS de excel por columnas",
	...
	"copy": {
		...
		"sFieldSeperator": "\t",
		"sNewLine": "auto",
		"sToolTip": "Copiar todos los registros al portapapeles",
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			alert( 'Se ha copiado '+len+' fila'+plural+' al portapapeles' );
		},
		"fnInit": null,
		"fnCellRender": null
	},
	"pdf": {
		...
		"sFieldSeperator": "\t",
		"sNewLine": "\n",
		"sFileName": "exportado.pdf",
		"sToolTip": "Exportar a formato PDF",
		"sTitle": "",
	...
	"print": {
		"sAction": "print",
		"sInfo": "<h6>Vista previa de impresión</h6><p>Por favor use la función imprimir del navegador para "+
		  "imprimir ésta tabla. Presione la tecla Esc para salir.",
		"sMessage": "",
		"bShowAll": true,
		"sToolTip": "Vista previa de impresión, presione esc al terminar la impresión",
