...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Administrar usuarios</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: ADMINISTRAR USUARIOS 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("usuarios_bus.php");
								break;
							 case "NUEVO":
							 	include_once("usuarios_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("usuarios_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("usuarios_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("usuarios_modif.php");
								modif_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR":
									include_once("usuarios_elim.php");
									eliminar_datos();
									break;	
								case "ELIMINAR_PLANT":
									include_once("plantel_asig_eliminar.php");
									eliminar_plant();
									break;																			
						 } // fin switch
					 ?>          
          ...
          <a id="nb" href="<?php echo "usuarios.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Buscar usuario
                              </a><br> 
            <?php 
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "usuarios.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
									<img src='../images/sistema/user_add.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Crear usuario&nbsp;               
                  </a><br>              
