...
$array_permisos=verificar_acceso_pagina($_GET['id_func']);} else{
...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - LOGS DE ACCESO AL SISTEMA</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      <img src="<?php 
											...
											switch ($accion){
												case "NUEVO" :
													echo "../images/icons_menu/x32/00415.png";
													break;
												case "GUARDAR" :
													echo "../images/icons_menu/x32/00415.png";
													break;
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: HISTORIAL DE ACCESOS AL SISTEMA
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
