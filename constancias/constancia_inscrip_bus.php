...
<form id="form_buscar" name="form_buscar" action="<?php echo "constancia_inscrip.php?id_func=".$_GET["id_func"]."&accion=mostrar" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
...
<br>
  ...
  <td colspan="2"><div class="ctrlHolder">
    ...
    <select name="cmb_valid" id="cmb_valid" size=1 class="csf validate[required]">
      <option value="">...</option>
      <option value="0">SIN VENCIMENTO</option>
      <?php 
				for ($i=1;$i<12;$i++){
