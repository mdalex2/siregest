...
<style>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])) echo $_SESSION['juego_caracteres']; else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title>SIREGEST V.2012.1 - M&Oacute;DULO: CONTROL DE INTEGRIDAD</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
<form id="form" name="form" action=""  method="post" enctype="multipart/form-data" class="uniForm">
	...
	<fieldset>
                      ...
                      <img src="../images/sistema/user_comment.png" width="32" height="32" align="absmiddle"> M&Oacute;DULO: CONTROL DE INTEGRIDAD DE DATOS</h1>
                      <hr>
<?php
