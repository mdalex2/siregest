...
<form id="form" name="form" action="email_agregar_frm.php?id_func=<?php if (isset($_GET["id_func"])){echo $_GET['id_func'];}?>&accion=guardar_email&id_per=<?php echo $_GET["id_per"];?>"  method="post" enctype="multipart/form-data" class="uniForm">
										<!-- Fieldset -->
	<fieldset>
										  <!--<legend>Configuración:</legend>-->
                      <h1 align="left" class="titulo_form_blue">
                      <img src="../images/icons_menu/x32/config.png" width="32" height="32" align="absmiddle"> AGREGAR EMAIL</h1>
                      <hr>
<?php
if (isset($_GET["accion"])){
	...
	switch ($accion){
		case "GUARDAR_EMAIL":
			include_once("email_guardar.php");
			guardar_email();
			break;
		default:
                            ...
                            <tr>
                              <td>
                                <div class="ctrlHolder">
                                  <label for="txt_email">Direcci&oacute;n de correo electr&oacute;nico</label><br>
                                  
                                  <input name="txt_email" type="text" class="validate[required,custom[email]] text-input Lf" id="txt_email"  size="41" maxlength="41"/>
                                  <p class="formHint"> (*) Ejm: maria@hotmail.com</p>
                                </div>									
</td>
                            </tr>
          <tr><td>
							<button  class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit" >
<span class="ui-button-text"><img src="../images/icons_menu/x32/telephone_add.png" width="20" height="20" align="absmiddle">&nbsp;Guardar email</span>
</button>
