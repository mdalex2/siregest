...
<title>Constancia de inscripci&oacute;n</title>
<style type="text/css">
.margenes td{
padding-left: 3px;
padding-right: 3px;
...
// ----- BUSCO DATOS DEL ALUMNO(A) ----
	...
	$cons_alumnos=ejecuta_sql($sql_alumno,false);
	if ($cons_alumnos){
...
<br /><br />
<center><span class="titulo" style="line-height: 300%;">CONSTANCIA DE INSCRIPCI&Oacute;N</span></center>
...
<center><span class="titulo">CERTIFICA</span></center>
<p align="justify" style="font-size:16px;line-height: 200%;">
