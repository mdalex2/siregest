...
<form id="form_buscar" name="form_buscar" action="<?php echo "registro_calif_rep.php?id_func=".$_GET["id_func"]."&accion=ver_reporte" ?>" method="post" enctype="multipart/form-data" class="uniForm" target="_blank">
<fieldset>
