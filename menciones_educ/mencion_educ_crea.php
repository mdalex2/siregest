...
<form id="form_crear" name="form_crear" action="<?php echo "mencion_educ.php?id_func=".$_GET["id_func"]."&accion=guardar" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<!-- Fieldset -->
...
<td colspan="2">
  <div class="ctrlHolder">
    ...
    <br>
    <input name="txt_cod" type="text" autofocus class="validate[required,minSize[5]] text-input sf"  id="txt_cod" tabindex="0" value="" maxlength="6"/>
...
<td colspan="2">
  ...
  <div class="ctrlHolder">
    ...
    <br>
    <input name="txt_men_edu" type="text" class="validate[required,minSize[3]] text-input lf"  id="txt_men_edu" tabindex="0" maxlength="50" />
...
<td>
  ...
  <br>
  <input name="txt_men_edu_abr" type="text" class="validate[required,minSize[2]] text-input ssf"  id="txt_men_edu_abr" tabindex="0" maxlength="3" />
...
<button type="submit" formaction="<?php echo "mencion_educ.php?id_func=".$_GET["id_func"]."&accion=guardar" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" id="btn_guardar">
