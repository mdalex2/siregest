...
<form id="form_editar" name="form_editar" action="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=inscribir&id_per=$id_personal#frm_asignaturas" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<!-- Fieldset -->
<?php
...
<tr><td colspan="3">
  ...
  <button type="submit" formaction="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=inscribir&id_per=$id_personal#frm_asignaturas" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" title="Validar y seleccionar asignaturas a inscribir">
...
<form id="form_asig_insc" name="form_asig_insc" action="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=genera_inscripcion" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<!-- Fieldset -->
<?php
...
<button type="submit" formaction="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=genera_inscripcion" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all tooltip" id="btn_guardar" title="Inscribir el alumno y mostrar planilla de inscripci&oacute;n" onclick="
