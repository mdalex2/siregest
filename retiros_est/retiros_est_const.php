...
$(document).ready(function() {
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: CONTANCIA DE RETIRO 
<?php 
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 ...
							 include_once("retiros_est_buscar_const.php");
								break;								
          ...
          <a id="nb" href="<?php echo "retiros_est_const.php?id_func=".$_GET["id_func"]."&accion=GENERAR_CONSTANCIA"?>"  title="Consultar datos de los retiros y generar constancia">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Consultar retiro
          </a><br> 
            <?php 
