<?php
  ...
  $cod_grado= $_REQUEST["id"];
	...
	) where inst_secciones.cod_plantel='$cod_plantel' AND inst_secciones.cod_grado='$cod_grado' AND inst_secciones.visible=true order by inst_secciones.seccion_corto ASC",false);
