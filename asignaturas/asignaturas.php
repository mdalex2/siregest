...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: ADMINISTRAR ASIGNATURAS 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("asig_bus.php");
								break;
							 case "NUEVO":
							 	include_once("asig_crea.php");
								break;
							 case "MOSTRAR":
          ...
          <a id="nb" href="<?php echo "asignaturas.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Buscar asignatura
                              </a><br> 
            <?php 
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "asignaturas.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nueva">
									<img src='../images/sistema/computer_add.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Crear asignatura&nbsp;               
                  </a><br>              
