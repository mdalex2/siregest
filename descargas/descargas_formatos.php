...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: DESCARGA DE FORMATOS
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
				...
				<div class="pad20">
					...
					<!-- comienzo la tabla de mostrar -->
						...
						<ul class="dash">
							<li>
								<a href="../plantillas/planilla_asist_est.xls" title="Planilla de asistencia de estudiantes" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Planilla asistencia </span>
								</a>
							</li>
							<li>
								<a href="../plantillas/planilla_inasist_est.xls" title="Planilla de inasistencia de estudiantes" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Planilla inasistencia </span>
								</a>
							</li>
              
							<li>
								<a href="../plantillas/res_final.xls" title="Planilla resumen final" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Resumen final</span>
								</a>
							</li> 
							<li>
								<a href="../plantillas/cert_calif.xls" title="Planilla notas certificadas" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Notas certificadas</span>
								</a>
							</li>
							<li>
								<a href="../plantillas/boletin_est.xls" title="Bolet&iacute;n de notas" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Boleta de notas</span>
								</a>
							<li>
								<a href="../plantillas/listado_calif_3lapsos.xls" title="Calificaci&oacute;n tres lapsos" class="tooltip">
									<img src="../images/sistema/downloads.png"  width="48px">
									<span>Califiaci&oacute;n tres lapsos</span>
								</a>
							</li>                                          
						</ul>
         <?php
