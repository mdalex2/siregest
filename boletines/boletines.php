...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Generar boleta estudiantil</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      <img src="<?php 
											...
											switch ($accion){
												case "NUEVA" :
													echo "../images/icons_menu/x32/00612.png";
													break;
												case "MOSTRAR":
													echo "../images/icons_menu/x32/00612.png";
													break;
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: GENERAR BOLETA ESTUDIANTIL
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
	if ($accion!=="INSCRIBIR")
...
?></h2>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "INDIVIDUAL":
							 	include_once("boletines_ind.php");
								break;
							 case "POR_SECCION":
							 	include_once("boletines_por_secc.php");
								break;	
							 case "GENERA_BOLETA":
							 	include_once("planilla_boleta.php");
								guardar_datos();
								break;								
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "boletines.php?id_func=".$_GET["id_func"]."&accion=por_seccion" ?>"  title="Consultar estudiantes por secci&oacute;n para generar sus boletas">
									<img src='../images/sistema/users_search.png' width='28' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Consultar secci&oacute;n&nbsp;               
                  </a><br> 
                  <!--
								<a id="an" href="<?php echo "boletines.php?id_func=".$_GET["id_func"]."&accion=individual" ?>"  title="Consulta individual de boletas estudiantiles">
									<img src='../images/sistema/preferences-contact-list.png' width='24' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Consulta individual&nbsp;               
                  </a><br>              
                   -->           
