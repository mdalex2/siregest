...
?>                  
<form id="form_buscar" name="form_buscar" action="<?php echo "retiros_est_const.php?id_func=".$_GET["id_func"]."&accion=generar_constancia" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
...
<td>  
<button formaction="<?php echo "retiros_est_const.php?id_func=".$_GET["id_func"]."&accion=generar_constancia" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit">
