...
<form id="form_buscar" name="form_buscar" action="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
...
<div class="ctrlHolder">
  ...
  <label for="txt_cedula" id="lbl_text_busc"><?php if (isset($_POST["lbl_text_busc1"])) echo $_POST["lbl_text_busc1"]; else echo " Escriba N&deg; de c&eacute;dula del estudiante"; ?></label><br>
...
<td>  
<button formaction="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit">
		...
		if ($consulta)
			{
				if (mysql_num_rows($consulta)==1) {
					...
					$url="notas_cert.php?id_func=".$_GET['id_func']."&accion=inscribir&id_per=".$fila['id_personal'];
					echo '
