...
<html>
<?php 
session_cache_limiter('nocache,private'); //evita mensaje de sesion expirada al presionar atras en el 
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAR ÉSTA INSTITUCIÓN? \n\n También se eliminarán todos los datos como inscripciones, configuraciones del sistema, notas o calificaciones entre otras actividades asignadas a éste plantel o institución. \n\n NOTA: SE RECOMIENDA NO ELIMINAR PLANTELES O INSTITUCIONES AL MENOS QUE LA MISMA SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar la institución?\n\n Ésta acción no se podrá deshacer y puede provocar fallos o pérdida de información.");
	if (agree)
		return true ;}
else
return false ;
...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Instituciones / Planteles Educativos</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: INSTITUCIONES / PLANTELES 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("inst_educativa_bus.php");
								break;
							 case "NUEVO":
							 	include_once("inst_educativa_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("inst_educativa_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("inst_educativa_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("inst_educativa_modif.php");
								...
								case "ELIMINAR_DIR":
									...
									break;
								case "ELIMINAR":
									include_once("inst_educativa_elim.php");
									eliminar_persona();
									break;																			
          ...
          <a id="nb" href="<?php echo "inst_educativa.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="inst_educativa_agr_dir.php?id_func=<?php echo $_GET["id_func"];?>&accion=nuevo"  title="Agregar nueva" class="fancybox.iframe resize_small">
									<img src='../images/sistema/computer_add.png' width='24' height="24" style="padding:2px;" heigth='24px' align='absmiddle'></img>&nbsp;Crear instituci&oacute;n&nbsp;               
                  </a><br>              
