...
{
var agree=confirm("¿Está seguro de eliminar éste año escolar?");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAR EL AÑO ESCOLAR? \n\n NOTA: SE RECOMIENDA NO ELIMINAR AÑOS ESCOLARES AL MENOS QUE EL MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar el año escolar?\n\n Ésta acción no se podrá deshacer.");
	if (agree)
		return true ;}
else
return false ;
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: ADMINISTRAR AÑO ESCOLAR 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("anno_esc_me_bus.php");
								break;
							 case "NUEVO":
							 	include_once("anno_esc_me_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("anno_esc_me_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("anno_esc_me_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("anno_esc_me_modif.php");
								modif_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR":
									include_once("anno_esc_me_elim.php");
									eliminar_datos();
									break;																			
          ...
          <a id="nb" href="<?php echo "anno_esc_me.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "anno_esc_me.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
