...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAREL TIPO DE DOCUMENTO DE IDENTIDAD? \n\n NOTA: SE RECOMIENDA NO ELIMINARLO AL MENOS QUE EL MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar el tipo de documento?\n\n Ésta acción no se podrá deshacer.");
	if (agree)
		return true ;}
else
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Tipos de documento de identidad</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: TIPOS DE DOCUMENTOS DE IDENTIDAD 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h2><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("tip_doc_bus.php");
								break;
							 case "NUEVO":
							 	include_once("tip_doc_crea.php");
								break;
							 case "MOSTRAR":
          ...
          <a id="nb" href="<?php echo "tip_doc.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "tip_doc.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
