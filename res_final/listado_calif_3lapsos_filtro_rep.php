...
<form id="form_buscar" name="form_buscar" action="<?php echo "listado_calif_3lapsos_rep.php?id_func=".$_GET["id_func"]."&accion=ver_reporte" ?>" method="post" enctype="multipart/form-data" class="uniForm" target="_blank">
<fieldset>
...
<br>
<SELECT name="cmb_gra" id="cmb_gra" SIZE=1 class="mf validate[required]" onChange="$('#cmb_secc').html('');$('#cmb_asig').html('');"> 
<option value="" style="width:100%">TODOS...</option>
<?php
	include_once("../funciones/funcionesPHP.php");
	$cod_plantel_session="";
...
<tr>
  <td colspan="2"><button formaction="<?php echo "listado_calif_3lapsos_rep.php?id_func=".$_GET["id_func"]."&accion=ver_reporte" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit" formtarget="_blank"> <span class="ui-button-text"><img src="../images/sistema/mos_rep.png" width="24" height="24" align="absmiddle">&nbsp;Mostrar reporte</span> </button>&nbsp;</td>
  <td>
    </td>
</tr>
</table>   
...
<table width="100%" border="0">
  <tr>
    <td width="..."><img src="../images/sistema/printerx128.png" width="128" height="128" align="absmiddle"></th>
    <td><p align="justify" style="font-size:16px; color:rgb(108,108,108);">&nbsp;Para imprimir el listado debe usar papel extra oficio y tener instalado alg&uacute;n programa de manejo de hojas de calculo como <img src="../images/sistema/excelx32.png" width="22" height="22" align="absmiddle"> Excel, Libre Office <img src="../images/sistema/openofficeorg_20_calcx32.png" width="24" height="24" align="absmiddle"> y/o openOffice.</p>&nbsp;</td>
  </tr>
</table>
</fieldset>
</html>