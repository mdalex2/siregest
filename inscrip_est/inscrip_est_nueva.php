...
<form id="form_buscar" name="form_buscar" action="<?php echo "inscrip_est.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
...
<td>  
<button formaction="<?php echo "inscrip_est.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit">
		...
		if ($consulta)
			{
				if (mysql_num_rows($consulta)==1) {
					...
					$url="inscrip_est.php?id_func=".$_GET['id_func']."&accion=inscribir&id_per=".$fila['id_personal'];
					echo '
