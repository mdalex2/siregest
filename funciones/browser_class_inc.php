...
class browser 
{
	...
	{
		// test for Opera		
		if (preg_match("opera",$this->useragent))
		{
	...
	{
		if(preg_match("/Konqueror/",$this->useragent))
		{
	...
	function isIEv1()
	{
		if(preg_match("/microsoft internet explorer/", $this->useragent))
		{
	...
	function isMSIE()
	{
		if(preg_match("/msie/", $this->useragent) && !preg_match("/opera/",$this->useragent))
		{
			$this->browsertype = "MSIE"; 
	...
	function isGaleon()
	{
		if(preg_match("/galeon/",$this->useragent))
		{
	...
	{
		if(preg_match("/NetPositive/", $this->useragent))
		{
	...
	function isMSPIE()
	{
		if(preg_match("/mspie/",$this->useragent) || preg_match("/pocket/", $this->useragent))
		{
	...
	function isIcab()
	{
		if(preg_match("/icab/",$this->useragent))
		{
	...
	function isOmniWeb()
	{
		if(preg_match("/omniweb/",$this->useragent))
		{
	...
	function isPhoenix()
	{
		if(preg_match("/Phoenix/", $this->useragent))
		{
	...
	function isFirebird()
	{
		if(preg_match("/firebird/", $this->useragent))
		{
	...
	function isLynx()
	{
		if(preg_match("/libwww/", $this->useragent))
		{
	...
	function isSafari()
	{
		if(preg_match("/safari/", $this->useragent))
		{
	...
	function isAOL()
	{
		if (preg_match("/AOL/", $this->useragent)){
