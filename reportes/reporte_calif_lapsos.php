...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Reporte de calificaciones por lapso</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
// --- LLENAR COMBO SECCION ---------------------
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: REPORTE DE CALIFICACIONES POR LAPSO Y ASIGNATURA
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
								case "BUSCAR":
									include_once("reporte_calif_lapsos_filtro_rep.php");
									break;			
								case "REPORTE":
									include_once("reporte_calif_lapsos_rep.php");
									break;																			
						 } // fin switch
					 ?>          
	  </div>
          ...
          <?php
						...
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "reporte_calif_lapsos.php?id_func=".$_GET["id_func"]."&accion=buscar" ?>"  >
