...
function confirm_elim_email()
{
var agree=confirm("¿Está seguro de eliminar ésta dirección de correo electrónico?");
if (agree)
return true ;
else
return false ;
}
function confirm_elim_repre()
{
var agree=confirm("¿Está seguro de eliminar ésta asociación de representante del estudiante? \n\nEsta acción no se podrá deshacer y no se eliminarán tampoco los datos personales del representante.");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿Está seguro de eliminar ésta dirección?");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAR ÉSTE EXPEDIENTE PERSONAL? \n\n También se eliminarán todos los datos como inscripciones, configuraciones del sistema, notas o calificaciones entre otras actividades asignadas a éste expediente. \n\n NOTA: SE RECOMIENDA NO ELIMINAR NINGÚN EXPEDIENTE AL MENOS QUE EL MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar un expediente?\n\n Ésta acción no se podrá deshacer y puede provocar fallos o pérdida de información.");
	if (agree)
		return true ;}
else
return false ;
...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Expediente personal</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      <img src="<?php 
											...
											switch ($accion){
												case "NUEVO" :
													echo "../images/icons_menu/x32/vcard_add.png";
													break;
												case "GUARDAR" :
													echo "../images/icons_menu/x32/vcard_edit.png";
													break;
												...
												case "MOSTRAR":
													...
													break;
												case "ELIMINAR":
													echo "../images/icons_menu/x32/vcard_delete.png";
													break;
												case "BUSCAR":
													echo "../images/icons_menu/x32/vcardsearch.png";
													break;
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: EXPEDIENTE PERSONAL 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
						    ...
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
									mostrar_box("inf",false,"NOTIFICACI&Oacute;N",$_SESSION["msg"]);
									//unset($_SESSION["msg"]);
									}
							 	include_once("datos_per_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("datos_per_guardar.php");
								guardar_datos_per(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("datos_per_modif.php");
								modif_datos_per(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR_TELF":
									include_once("telf_eliminar.php");
									eliminar_telf();
									break;
								case "ELIMINAR_EMAIL":
									include_once("email_eliminar.php");
									eliminar_email();
									break;
									
								case "ELIMINAR_DIR":
									include_once("direcc_eliminar.php");
									eliminar_direcc();
									break;
								case "ELIMINAR_REPRE":
									include_once("repre_elim.php");
									eliminar_repre();
									break;
									
								case "ELIMINAR":
									include_once("datos_per_elim.php");
									eliminar_persona();
									break;																			
          ...
          <a id="nb" href="<?php echo "datos_per.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Nueva busqueda
                              </a><br> 
            <?php 
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "datos_per.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nueva">
									<img src='../images/icons_menu/x32/vcard_add.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Crear expediente&nbsp;               
                  </a><br>
          <?php } //cierro el si tiene permiso de crear ?>
            <?php
							if (!empty($_GET["accion"]) && !empty($id_personal)){
						?>
								<a id="an" href="../inscrip_est/inscrip_est.php?id_func=00052&<?php 
								if (!empty($id_personal)){
									echo "accion=inscribir&id_per=$id_personal";
								} else {
									echo "accion=nueva";
								}
								?>"  title="Inscribir alumno">
									<img src='../images/icons_menu/x32/00052.png' width='24' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Inscribir estudiante&nbsp;               
                  </a><br>								
						<?php	
							}
						?>
