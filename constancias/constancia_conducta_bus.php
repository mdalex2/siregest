...
<form id="form_buscar" name="form_buscar" action="<?php echo "constancia_conducta.php?id_func=".$_GET["id_func"]."&accion=mostrar" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
...
<br>
  ...
  <td colspan="2"><div class="ctrlHolder">
    ...
    <select name="cmb_valid" id="cmb_valid" size=1 class="cssf validate[required]">
      <option value="">...</option>
