...
// --- LLENAR COMBO SECCION ---------------------
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: SOLICITUD DE CONSTANCIAS DE CONDUCTA
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "MOSTRAR":
							 	include_once("constancia_conducta_mos_res.php");
								break;
								case "BUSCAR":
							 	include_once("constancia_conducta_bus.php");
								break;			
								case "REPORTE":
									include_once("constancia_conducta_filtro.php");
									break;																			
						 } // fin switch
					 ?>          
	  </div>
          ...
          <?php
						...
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "constancia_conducta.php?id_func=".$_GET["id_func"]."&accion=buscar" ?>"  title="Permite buscar estudiantes para generar constancias">
          ...
          <a id="nb" href="<?php echo "constancia_conducta.php?id_func=".$_GET["id_func"]."&accion=imprimir_asignacion"?>"  title="Ver asignación de materias al plan de estudio">
