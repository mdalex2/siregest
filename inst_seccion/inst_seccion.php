...
function confirm_elim1()
{
var agree=confirm("¿Está seguro de eliminar ésta sección?");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAR ÉSTA SECCIÓN? \n\n NOTA: SE RECOMIENDA NO ELIMINAR NINGUNA SECCIÓN AL MENOS QUE LA MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar una sección?\n\n Ésta acción no se podrá deshacer.");
	if (agree==true)
		return true ;}
else {
		return false ;}
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Administrar secciones</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: ADMINISTRAR SECCIONES 
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("inst_seccion_bus.php");
								break;
							 case "NUEVO":
							 	include_once("inst_seccion_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("inst_seccion_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("inst_seccion_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("inst_seccion_modif.php");
								modif_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR":
									include_once("inst_seccion_elim.php");
									eliminar_datos();
									break;																			
          ...
          <a id="nb" href="<?php echo "inst_seccion.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Buscar secciones
          </a><br> 
            <?php 
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "inst_seccion.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
									<img src='../images/sistema/computer_add.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Crear secci&oacute;n&nbsp;               
                  </a><br>              
