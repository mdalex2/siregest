...
<form id="form_buscar" name="form_buscar" action="<?php echo "retiros_est.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" method="post" enctype="multipart/form-data" class="uniForm">
<fieldset>
<legend>Buscar estudiante a retirar:</legend>
...
<div class="ctrlHolder">
  ...
  <label for="txt_cedula" id="lbl_text_busc"><?php if (isset($_POST["lbl_text_busc1"])) echo $_POST["lbl_text_busc1"]; else echo " Escriba N&deg; de c&eacute;dula del estudiante a retirar"; ?></label><br>
...
<td>  
<button formaction="<?php echo "retiros_est.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>" class="ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" type="submit">
		...
		if ($consulta)
			{
				if (mysql_num_rows($consulta)==1) {
					...
					$url="retiros_est.php?id_func=".$_GET['id_func']."&accion=retirar&id_per=".$fila['id_personal'];
					echo '
...
<table id="tablasinbtn" class="letra_16 mouse_hover" width="648"> 
        <thead> 
          <tr>
            ...
            <th width="90px" title="retirar alumno">INSC.</th>
        ...
        <?php
          ...
          <tr>
            ...
            <td align="center"><a id="resize" href="retiros_est.php?<?php echo "id_func=".$_GET['id_func']."&accion=retirar&id_per={$fila['id_personal']}";?>" class=" ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="retirar &eacute;ste alumno" >&nbsp; <img src='../images/sistema/computer_go.png' title="retirar estudiante" width='20' heigth='20px' align='absmiddle'></img>&nbsp;retirar </a></td>
