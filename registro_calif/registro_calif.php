...
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Registro de calificaciones</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
// --- LLENAR COMBO SECCION ---------------------
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: REGISTRO DE CALIFICACIONES
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
						    ...
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("registro_calif_mos.php");
								break;
								case "BUSCAR":
							 	include_once("registro_calif_bus.php");
								break;			
									
								case "ADMINISTRAR":
									include_once("registro_calif_admin.php");
									break;	
								case "GUARDAR":
									include_once("registro_calif_gua.php");
									break;																			
								case "REPORTE":
									include_once("registro_calif_filtro_rep.php");
									break;																			
						 } // fin switch
					 ?>          
	  </div>
          ...
          <?php
						...
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "registro_calif.php?id_func=".$_GET["id_func"]."&accion=buscar" ?>"  title="Permite buscar para editar los registros de calificaciones de estudiantes">
									<img src='../images/sistema/lupa_hoja.png' width='24' height="24" style="padding:2px;" heigth='24px' align='absmiddle'></img>&nbsp;Buscar registros&nbsp;               
                  </a><br>              
          ...
          <?php
						...
						if ($array_permisos["imprimir"]==true) {?>
								<a id="rep" href="<?php echo "registro_calif.php?id_func=".$_GET["id_func"]."&accion=reporte" ?>">
									<img src='../images/icons_menu/x32/printer2_x32.png' width='24' height="24" style="padding:2px;" heigth='24px' align='absmiddle'></img>&nbsp;Reporte de calificaciones               
                  </a><br>              
          <?php } //cierro el si tiene permiso de crear ?>
        ...
        <?php 
          ...
          <a id="nb" href="<?php echo "registro_calif.php?id_func=".$_GET["id_func"]."&accion=imprimir_asignacion"?>"  title="Ver asignación de materias al plan de estudio">
