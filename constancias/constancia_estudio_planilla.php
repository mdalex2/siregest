...
// ----- BUSCO DATOS DE DIRECTOR(A) ----
	...
	if ($cons_plantel){
		...
		$nombre_plantel=trans_texto($fila_plantel["den_plantel"],"TI"); //transformo tipo titulo
		//$nombre_plantel=ucwords(strtolower($fila_plantel["den_plantel"]));
...
<br /><br /><br /><br />
<center>
<span class="titulo" style="line-height: 300%;">CONSTANCIA DE ESTUDIO</span>
</center><br /><br />
...
<table width="100%" border="0" style="font-size:16px;">
  <tr>
    ...
    <th scope="col" style="border-top:1px solid black;"><?php 
		echo trans_texto(($nombre_director." ".$apellido_director),"MA")."<br>";
		echo formatear_id_personal($num_id_per,$tipo_doc_abr,$poner_num,$separador,$num_con_punto)."<br>";
		echo trans_texto($genero_direct,"MA");
		?></th>
    <th scope="col" width="30%">&nbsp;</th>
  </tr>
</table>
