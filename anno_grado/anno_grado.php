...
{
var agree=confirm("¿Está seguro de eliminar este año o grado?");
if (agree)
return true ;
else
return false ;
...
{
var agree=confirm("¿ESTÁ SEGURO QUE DESEA ELIMINAR EL AÑO O GRADO \n\n Esto provocará que las notas registradas para éste año o grado tambien se eliminen. \n\n NOTA: SE RECOMIENDA NO ELIMINAR AÑOS O GRADOS AL MENOS QUE EL MISMO SE HALLA REGISTRADO POR ERROR");
if (agree){
	var agree=confirm("¿En realidad deseas eliminar el año o grado?\n\n Ésta acción no se podrá deshacer.");
	if (agree)
		return true ;}
else
return false ;
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Año o grado</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: ADMINISTRAR NIVEL DE ESTUDIO
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?></h1><hr>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "BUSCAR":
							 	include_once("anno_grado_bus.php");
								break;
							 case "NUEVO":
							 	include_once("anno_grado_crea.php");
								break;
							 case "MOSTRAR":
						    if (isset($_SESSION["msg"]) && $_SESSION["msg"]!=""){
							 	...
							 	include_once("anno_grado_mos.php");
								break;	
								case "GUARDAR":
							 	include_once("anno_grado_guardar.php");
								guardar_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;			
								case "MODIFICAR":
							 	include_once("anno_grado_modif.php");
								modif_datos(); //llamo a la funcion que me guarda los datos en la BD
								break;
								case "ELIMINAR":
									include_once("anno_grado_elim.php");
									eliminar_datos();
									break;																			
          ...
          <a id="nb" href="<?php echo "anno_grado.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "anno_grado.php?id_func=".$_GET["id_func"]."&accion=nuevo" ?>"  title="Agregar nuevo">
