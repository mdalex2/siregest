...
$(document).ready(function() {
 ...
 -->
					...
					<h1 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: NOTAS CERTIFICADAS
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
	if ($accion!=="INSCRIBIR")
...
?></h1>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
							 case "NUEVA":
							 	include_once("notas_cert_nueva.php");
								break;
							 case "INSCRIBIR":
							 	include_once("notas_cert_ins.php");
								break;	
							 case "BUSCAR":
							 	include_once("notas_cert_bus.php");
								break;	
								
							 case "GENERA_INSCRIPCION":
							 	include_once("notas_cert_guardar.php");
								guardar_datos();
								break;								
          ...
          <a id="nb" href="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=buscar"?>"  title="Consultar datos">
                                <img src='../images/icons_menu/x32/search_x32.png' width='24px' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Consultar
          </a><br> 
            <?php 
            ...
            <?php          
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "notas_cert.php?id_func=".$_GET["id_func"]."&accion=nueva" ?>"  title="Generar nueva certificación de calificaciones">
									<img src='../images/icons_menu/x32/00052.png' width='24' heigth='24px' align='absmiddle' style="padding:2px;"></img>&nbsp;Generar nueva cert.&nbsp;               
                  </a><br>              
