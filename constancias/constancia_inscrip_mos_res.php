		...
		$id_seccion=$fila_alum["id_seccion"];
          ...
          <tr>
            ...
            <td align="center">
 							...
 							<a id="resize" href="constancia_inscrip_planilla.php?<?php echo "id_func=".$_GET['id_func']."&id_per={$fila_alum['id_personal']}&cod_anno_esc=$cod_anno_esc_bus&vl=$valides&cod_plan=$cod_plantel&id_dir=$id_director&id_secc=$id_seccion";?>" class=" ui-button ui-button-text-only ui-widget ui-state-default ui-corner-all fancybox.iframe resize" style="font-size:10px;padding:2px; color:#000000;" width="45%" height="90%" title="Mostrar constancia" >&nbsp;
