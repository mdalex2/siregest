...
// --- LLENAR COMBO SECCION ---------------------
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: LISTADO ASIGANCI&Oacute;N DE DOCENTES
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
...
?>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
								case "BUSCAR":
									include_once("listado_asig_doc_filtro_rep.php");
									break;			
								case "REPORTE":
									include_once("listado_asig_doc_rep.php");
									break;																			
						 } // fin switch
					 ?>          
	  </div>
          ...
          <?php
						...
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "listado_asig_doc.php?id_func=".$_GET["id_func"]."&accion=buscar" ?>"  >
