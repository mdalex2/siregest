...
-->
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=<?php if (isset($_SESSION['juego_caracteres'])){ echo $_SESSION['juego_caracteres'];} else echo "utf-8";//esta variable se declara en modulo verificar login?>">
	<title><?php echo $_SESSION["app_nombre"]."-".$_SESSION["app_version"]; ?> - Listado de calificaciones de los tres lapsos</title>
  <!-- End of Meta -->
    <!-- Scripts Graybox -->
...
// --- LLENAR COMBO SECCION ---------------------
 ...
 -->
					...
					<h2 align="left" class="titulo_form_blue">
                      ...
                      " width="32" height="32" align="absmiddle"> M&Oacute;DULO: LISTADO DE CALIFICACIONES TRES LAPSOS
<?php 
if (isset($_GET["accion"])){
  $accion=strtoupper($_GET["accion"]);
	if ($accion=="MOSTRAR" && $array_permisos["editar"]==true)
			echo " / BUSCAR SECCI&Oacute;N";
		else
		   echo " / $accion";
	}
...
?>
 ...
 <?php
					 if (!isset($_GET["accion"])){
						 ...
						 switch ($accion){
								case "BUSCAR":
									include_once("listado_calif_3lapsos_filtro_rep.php");
									break;			
								case "REPORTE":
									include_once("listado_calif_3lapsos_rep.php");
									break;																			
						 } // fin switch
					 ?>          
	  </div>
          ...
          <?php
						...
						if ($array_permisos["crear"]==true) {?>
								<a id="an" href="<?php echo "listado_calif_3lapsos.php?id_func=".$_GET["id_func"]."&accion=buscar" ?>"  >
									<img src='../images/sistema/lupa_hoja.png' width='24' height="24" style="padding:2px;" heigth='24px' align='absmiddle'></img>&nbsp;Nueva b&uacute;squeda&nbsp;               
                  </a><br>              
